...
public class ProblemSwedish {
    ...
    private enum Type { bounding, startPos, goalPos, obstacle };
    ...
    private void read_polygons(string jsonString) {
        ...
        for (int i = 0; i < json.Length; i++) {
            if (json[i].Contains("bounding_polygon") || json[i].Contains("start_positions") || json[i].Contains("goal_positions") || json[i].Contains("obstacle_")) {
