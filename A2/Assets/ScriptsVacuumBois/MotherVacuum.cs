...
public class MotherVacuum : MonoBehaviour {

    ProblemVacuum problem;
    public string problemPath = "P23.json";
    ...
    VisibilityGraphVacuum vGraph;
    List<GameObject> points;
    List<MotionModelVacuum> bois;
    SOMVacuum som;
    Prims prim;
    ...
    void spawnObjects()
    {
        ...
        scanningRadius = Mathf.Sqrt((boundingMaxX - boundingMinX) * (boundingMaxZ - boundingMinZ) / (20*Mathf.PI))/2;
    ...
    MotionModelVacuum spawnBoi(float[] origin, string name, float orientation, float radius)
    {
